...
IPv6RoutingHeader_Base::IPv6RoutingHeader_Base(const IPv6RoutingHeader_Base& other) : IPv6ExtensionHeader()
{
    address_arraysize = 0;
    this->address_var = 0;
    operator=(other);
...
void IPv6RoutingHeader_Base::setRoutingType(unsigned short routingType_var)
{
...
void IPv6RoutingHeader_Base::setSegmentsLeft(unsigned short segmentsLeft_var)
{
...
void IPv6RoutingHeader_Base::setAddress(unsigned int k, const IPv6Address& address_var)
{
    if (k>=address_arraysize) throw cRuntimeError("Array of size %d indexed by %d", address_arraysize, k);
...
IPv6DestinationOptionsHeader_Base::IPv6DestinationOptionsHeader_Base(const IPv6DestinationOptionsHeader_Base& other) : IPv6ExtensionHeader()
{
    operator=(other);
}
...
void IPv6EncapsulatingSecurityPayloadHeader::setSpi(int spi_var)
{
    this->spi_var = spi_var;
}
