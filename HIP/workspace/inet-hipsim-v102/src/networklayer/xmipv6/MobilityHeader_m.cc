...
MobilityHeader::MobilityHeader(const MobilityHeader& other) : cPacket()
{
...
void MobilityHeader::setMobilityHeaderType(int mobilityHeaderType_var)
{
    this->mobilityHeaderType_var = mobilityHeaderType_var;
}
...
BindingUpdate::BindingUpdate(const BindingUpdate& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void BindingUpdate::setLifetime(unsigned int lifetime_var)
{
...
void BindingUpdate::setSequence(unsigned int sequence_var)
{
...
void BindingUpdate::setAckFlag(bool ackFlag_var)
{
    this->ackFlag_var = ackFlag_var;
}
...
void BindingUpdate::setHomeRegistrationFlag(bool homeRegistrationFlag_var)
{
    this->homeRegistrationFlag_var = homeRegistrationFlag_var;
}
...
void BindingUpdate::setLinkLocalAddressCompatibilityFlag(bool linkLocalAddressCompatibilityFlag_var)
{
    this->linkLocalAddressCompatibilityFlag_var = linkLocalAddressCompatibilityFlag_var;
}
...
void BindingUpdate::setKeyManagementFlag(bool keyManagementFlag_var)
{
    this->keyManagementFlag_var = keyManagementFlag_var;
}
...
void BindingUpdate::setHomeAddressMN(const IPv6Address& homeAddressMN_var)
{
    this->homeAddressMN_var = homeAddressMN_var;
}
...
void BindingUpdate::setBindingAuthorizationData(int bindingAuthorizationData_var)
{
    this->bindingAuthorizationData_var = bindingAuthorizationData_var;
}
...
BindingAcknowledgement::BindingAcknowledgement(const BindingAcknowledgement& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void BindingAcknowledgement::setStatus(int status_var)
{
...
void BindingAcknowledgement::setSequenceNumber(unsigned int sequenceNumber_var)
{
...
void BindingAcknowledgement::setLifetime(unsigned int lifetime_var)
{
    this->lifetime_var = lifetime_var;
}
...
void BindingAcknowledgement::setKeyManagementFlag(bool keyManagementFlag_var)
{
    this->keyManagementFlag_var = keyManagementFlag_var;
}
...
void BindingAcknowledgement::setBindingAuthorizationData(int bindingAuthorizationData_var)
{
    this->bindingAuthorizationData_var = bindingAuthorizationData_var;
}
...
BindingError::BindingError(const BindingError& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void BindingError::setStatus(int status_var)
{
    this->status_var = status_var;
}
...
void BindingError::setHomeAddress(const IPv6Address& homeAddress_var)
{
    this->homeAddress_var = homeAddress_var;
}
...
HomeTestInit::HomeTestInit(const HomeTestInit& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void HomeTestInit::setHomeInitCookie(unsigned int homeInitCookie_var)
{
    this->homeInitCookie_var = homeInitCookie_var;
}
...
HomeTest::HomeTest(const HomeTest& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void HomeTest::setHomeInitCookie(unsigned int homeInitCookie_var)
{
    this->homeInitCookie_var = homeInitCookie_var;
}
...
void HomeTest::setHomeKeyGenToken(unsigned int homeKeyGenToken_var)
{
    this->homeKeyGenToken_var = homeKeyGenToken_var;
}
...
CareOfTestInit::CareOfTestInit(const CareOfTestInit& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void CareOfTestInit::setCareOfInitCookie(unsigned int careOfInitCookie_var)
{
    this->careOfInitCookie_var = careOfInitCookie_var;
}
...
CareOfTest::CareOfTest(const CareOfTest& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
void CareOfTest::setCareOfInitCookie(unsigned int careOfInitCookie_var)
{
    this->careOfInitCookie_var = careOfInitCookie_var;
}
...
void CareOfTest::setCareOfKeyGenToken(unsigned int careOfKeyGenToken_var)
{
    this->careOfKeyGenToken_var = careOfKeyGenToken_var;
}
...
BindingRefreshRequest::BindingRefreshRequest(const BindingRefreshRequest& other) : MobilityHeader()
{
    setName(other.getName());
    operator=(other);
}
...
HomeAddressOption_Base::HomeAddressOption_Base(const HomeAddressOption_Base& other) : IPv6DestinationOptionsHeader()
{
    operator=(other);
}
...
void HomeAddressOption_Base::setHomeAddress(const IPv6Address& homeAddress_var)
{
    this->homeAddress_var = homeAddress_var;
}
