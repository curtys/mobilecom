...
void IPv6NDPrefixInformation::setRouterAddress(bool routerAddress_var)
{
    this->routerAddress_var = routerAddress_var;
}
...
MIPv6NDAdvertisementInterval::MIPv6NDAdvertisementInterval(const MIPv6NDAdvertisementInterval& other) : cObject()
{
    operator=(other);
}
...
void MIPv6NDAdvertisementInterval::setAdvertisementInterval(unsigned int advertisementInterval_var)
{
    this->advertisementInterval_var = advertisementInterval_var;
}
...
MIPv6HAInformation::MIPv6HAInformation(const MIPv6HAInformation& other) : cObject()
{
    operator=(other);
}
...
void MIPv6HAInformation::setHomeAgentPreference(unsigned int homeAgentPreference_var)
{
    this->homeAgentPreference_var = homeAgentPreference_var;
}
...
void MIPv6HAInformation::setHomeAgentLifetime(unsigned int homeAgentLifetime_var)
{
    this->homeAgentLifetime_var = homeAgentLifetime_var;
}
...
void IPv6RouterAdvertisement::setHomeAgentFlag(bool homeAgentFlag_var)
{
    this->homeAgentFlag_var = homeAgentFlag_var;
}
...
void IPv6RouterAdvertisement::setAdvInterval(const MIPv6NDAdvertisementInterval& advInterval_var)
{
    this->advInterval_var = advInterval_var;
}
...
void IPv6RouterAdvertisement::setHaInformation(const MIPv6HAInformation& haInformation_var)
{
    this->haInformation_var = haInformation_var;
}
