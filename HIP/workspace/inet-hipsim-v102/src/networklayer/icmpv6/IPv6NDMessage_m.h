...
class IPv6NDPrefixInformation : public ::cObject
{
  ...
  public:
    ...
    virtual void setRouterAddress(bool routerAddress_var);
...
class MIPv6NDAdvertisementInterval : public ::cObject
{
  ...
  public:
    ...
    virtual void setAdvertisementInterval(unsigned int advertisementInterval_var);
};
...
class MIPv6HAInformation : public ::cObject
{
  ...
  public:
    ...
    virtual void setHomeAgentPreference(unsigned int homeAgentPreference_var);
    virtual unsigned int getHomeAgentLifetime() const;
    virtual void setHomeAgentLifetime(unsigned int homeAgentLifetime_var);
};
...
class IPv6RouterAdvertisement : public ::IPv6NDMessage
{
  ...
  public:
    ...
    virtual void setHomeAgentFlag(bool homeAgentFlag_var);
    ...
    virtual void setAdvInterval(const MIPv6NDAdvertisementInterval& advInterval_var);
    ...
    virtual void setHaInformation(const MIPv6HAInformation& haInformation_var);
};
